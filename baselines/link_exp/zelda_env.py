...
DIRECTIONS = collections.defaultdict(
    lambda: None,
    {
        0x08: "N",
        0x04: "S",
...
PULSE_1_IM_TYPES = collections.defaultdict(
    lambda: None,
    {
...
PULSE_2_IM_TYPES = collections.defaultdict(
    lambda: None,
    {
        0x80: "Death Spiral",
...
SWORD_TYPES = collections.defaultdict(
    lambda: None,
    {
        0x00: "None",
        0x01: "Sword",
...
ARROWS_TYPES = collections.defaultdict(
    lambda: None,
    {
        0x00: "None",
        0x01: "Arrow",
...
CANDLE_TYPES = collections.defaultdict(
    lambda: None,
    {
        0x00: "None",
        0x01: "Blue Candle",
...
POTION_TYPES = collections.defaultdict(
    lambda: None,
    {
        0x00: "None",
        0x01: "Life Potion",
...
RING_TYPES = collections.defaultdict(
    lambda: None,
    {
        0x00: "None",
        0x01: "Blue Ring",
